...
* *Exercise 9.15*: Modify the _roles_ relationship property.
...
== Exercise 9.15: Modify the _roles_ relationship property (Instructions)
...
== Exercise 9.15: Modify the _roles_ relationship property (Solution)
