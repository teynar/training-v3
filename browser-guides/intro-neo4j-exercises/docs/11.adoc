...
* *Exercise 11.15*: Modify the _roles_ relationship property.
...
== Exercise 11.15: Modify the _roles_ relationship property (Instructions)
...
== Exercise 11.15: Modify the _roles_ relationship property (Solution)
