...
You will see how in your real application, you must take care not to create duplicate nodes and relationships in your graphs.
...
* *Exercise 12.15*: Modify the _roles_ relationship property.
...
In fact, you must *never* create nodes and relationships together like this! This example is here to show you how powerful Cypher can be.
...
It will have no relationships, but you can specify DETACH just to be certain.
...
== Exercise 12.15: Modify the _roles_ relationship property (Instructions)

*Modify the relationship property, _roles_ for their roles in _Forrest Gump_:*
...
== Exercise 12.15: Modify the _roles_ relationship property (Solution)
...
You must take care not to create duplicate nodes and relationships in your real application graphs.
