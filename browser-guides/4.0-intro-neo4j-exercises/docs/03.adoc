...
* *Exercise 3.2*: Retrieve the names of all people who wrote the movie _Speed Racer_.
* *Exercise 3.3*: Retrieve the titles of all movies that are connected to the person, _Tom Hanks_, by an outgoing relationship.
...
== Exercise 3.2: Retrieve the names of all people who wrote the movie _Speed Racer_ (Instructions)

*Retrieve the names of all people who wrote the movie _Speed Racer_.*

== Exercise 3.2: Retrieve the names of all people who wrote the movie _Speed Racer_ (Solution)
...
== Exercise 3.2: Retrieve the names of all people who wrote the movie _Speed Racer_ (Taking it further - optional)

* Retrieve the names of all people who have written other movies.
* Retrieve the names of all people who have acted in a particular movie.
* Retrieve the names of all people who have directed a particular movie.

== Exercise 3.3: Retrieve the titles of all movies that are connected to the person, _Tom Hanks_, by an outgoing relationship (Instructions)

*Retrieve the titles of all movies connected with _Tom Hanks_ by an outgoing relationship.*

*Hint:* _Tom Hanks_ has multiple relationships with a movie so you do not specify a relationship type in the query.


== Exercise 3.3: Retrieve the titles of all movies that are connected to the person, _Tom Hanks_ (Solution)

*Retrieve the titles of all movies connected with _Tom Hanks_.*
...
== Exercise 3.3: Retrieve the titles of all movies that are connected to the person, _Tom Hanks_, by an outgoing relationship (Taking it further - optional)

* Retrieve the titles of all movies connected with another actor.
* Retrieve the names of all people connected with a particular movie.
...
Write and execute the Cypher query to retrieve all the roles that _Tom Hanks_ acted in.
