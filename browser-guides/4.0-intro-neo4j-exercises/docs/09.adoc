...
Do you notice that not all of these nodes are not females?
...
The _Robin Williams_ node must not have the label _Female_.
...
*Hint:* This movie will also have the label _OlderMovie_.
