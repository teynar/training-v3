...
They will have already populated the database from the *Neo4j Guided Exercise* in the previous lesson,
...
* You can read the instruction and try to answer the question.
* Whether or not you have an answer you can continue on to the answer page.
...
* ... along with *relationship direction*. You will use them as often as you can.
