...
Your first step is to become familiar with the data that you want to load into the graph.
...
[.notes]
--
If you were to load thousands or more questions, you must ensure that you have created uniqueness constraints on _Question.question_id_ and _User.name_ before you attempt the load.
--
...
[%interactive.answers]
- [ ] Scheduling when a load must occur.
