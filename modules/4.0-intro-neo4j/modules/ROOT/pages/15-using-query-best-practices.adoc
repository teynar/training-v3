...
In a deployed application, you will not *hard code*  values in your Cypher statements.
...
[.notes]
--
Here is a very high-level list of some of the best practices you will aim for in your Cypher queries:
--
