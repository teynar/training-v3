...
[IMPORTANT]
In Neo4j 4.3, `exists()` has been deprecated and may not work in future releases. In this Cypher you can use `CREATE CONSTRAINT ExistsMovieTagline ON (m:Movie) ASSERT m.tagline IS NOT NULL`.
