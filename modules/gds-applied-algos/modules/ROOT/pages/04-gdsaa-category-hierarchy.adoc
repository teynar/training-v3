...
. In your React web application, click *Business Search* and then click the pane for selecting a category. You will see a very long list of categories. You will use the Overlap Similarity algorithm to create relationships in the graph that will be used to identify the top-level categories.
