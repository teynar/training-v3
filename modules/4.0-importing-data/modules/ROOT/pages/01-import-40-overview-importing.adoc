...
[.notes]
--
Before you import data into the graph, you will have an idea of the target graph data model you want to achieve.
You must work with the data architects for your application so that everybody agrees upon:
--
...
These graph data model components must be agreed upon before you import the data.
