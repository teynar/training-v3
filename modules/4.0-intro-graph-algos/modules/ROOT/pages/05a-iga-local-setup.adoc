...
[start=4]
. A new browser tab will open for this address.
. Copy this address to your clipboard. It will be: https://neo.jfrog.io/neo/api/npm/npm/neuler.
. In the left *Graph Apps* panel, paste this address in the *Install* field at the bottom.
. Click *Install*.
. The *Graph Data Science Graph Playground* Graph App will now appear in the left pane.
